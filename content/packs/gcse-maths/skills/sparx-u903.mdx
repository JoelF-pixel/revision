...
type: skill
id: sparx-u903
title: Adding and subtracting column vectors
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Adding and subtracting column vectors**.
...
- **Can I define it?** Write a one-sentence definition of *Adding and subtracting column vectors* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Adding%20and%20subtracting%20column%20vectors
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Adding%20and%20subtracting%20column%20vectors
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Adding%20and%20subtracting%20column%20vectors

## Revision links
- Sparx topic code: **U903** (paste into Sparx search)
