...
type: skill
id: sparx-u887
title: Geometric proofs with congruence and similarity
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
prereqs:
  - maths-subsection-geometry-geometric-proofs-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Geometric proofs with congruence and similarity**.
...
- **Can I define it?** Write a one-sentence definition of *Geometric proofs with congruence and similarity* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Geometric%20proofs%20with%20congruence%20and%20similarity
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Geometric%20proofs%20with%20congruence%20and%20similarity
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Geometric%20proofs%20with%20congruence%20and%20similarity

## Revision links
- Sparx topic code: **U887** (paste into Sparx search)
