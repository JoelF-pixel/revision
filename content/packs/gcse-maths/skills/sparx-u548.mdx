...
type: skill
id: sparx-u548
title: Multiplying and dividing with negative numbers
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
prereqs:
  - maths-subsection-number-negative-numbers-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Multiplying and dividing with negative numbers**.
...
- **Can I define it?** Write a one-sentence definition of *Multiplying and dividing with negative numbers* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Multiplying%20and%20dividing%20with%20negative%20numbers
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Multiplying%20and%20dividing%20with%20negative%20numbers
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Multiplying%20and%20dividing%20with%20negative%20numbers

## Revision links
- Sparx topic code: **U548** (paste into Sparx search)
