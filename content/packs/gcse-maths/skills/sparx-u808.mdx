...
type: skill
id: sparx-u808
title: "Mixed problems: Circle theorems"
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Mixed problems: Circle theorems**.
...
- **Can I define it?** Write a one-sentence definition of *Mixed problems: Circle theorems* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Mixed%20problems%3A%20Circle%20theorems
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Mixed%20problems%3A%20Circle%20theorems
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Mixed%20problems%3A%20Circle%20theorems

## Revision links
- Sparx topic code: **U808** (paste into Sparx search)
