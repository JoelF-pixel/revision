...
- Write down the given information and what you are asked to find for **Reflecting graphs**.
...
- **Can I define it?** Write a one-sentence definition of *Reflecting graphs* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Reflecting%20graphs
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Reflecting%20graphs
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Reflecting%20graphs

## Revision links
- Sparx topic code: **U487** (paste into Sparx search)
