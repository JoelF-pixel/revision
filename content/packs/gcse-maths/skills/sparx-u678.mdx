...
type: skill
id: sparx-u678
title: Using a pair of compasses
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Using a pair of compasses**.
...
- **Can I define it?** Write a one-sentence definition of *Using a pair of compasses* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20a%20pair%20of%20compasses
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20a%20pair%20of%20compasses
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20a%20pair%20of%20compasses

## Revision links
- Sparx topic code: **U678** (paste into Sparx search)
