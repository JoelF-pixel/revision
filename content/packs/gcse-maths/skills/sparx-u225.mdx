...
- Write down the given information and what you are asked to find for **Estimating calculations**.
...
- **Can I define it?** Write a one-sentence definition of *Estimating calculations* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Estimating%20calculations
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Estimating%20calculations
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Estimating%20calculations

## Revision links
- Sparx topic code: **U225** (paste into Sparx search)
