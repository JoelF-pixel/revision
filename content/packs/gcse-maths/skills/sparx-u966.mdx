...
type: skill
id: sparx-u966
title: Plotting distance-time graphs using speeds
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Plotting distance-time graphs using speeds**.
...
- **Can I define it?** Write a one-sentence definition of *Plotting distance-time graphs using speeds* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Plotting%20distance-time%20graphs%20using%20speeds
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Plotting%20distance-time%20graphs%20using%20speeds
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Plotting%20distance-time%20graphs%20using%20speeds

## Revision links
- Sparx topic code: **U966** (paste into Sparx search)
