...
type: skill
id: sparx-u120
title: Collecting and recording data using tables
quadrant: Statistics
ring: Grade 4–6
...
- Write down the given information and what you are asked to find for **Collecting and recording data using tables**.
...
- **Can I define it?** Write a one-sentence definition of *Collecting and recording data using tables* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Collecting%20and%20recording%20data%20using%20tables
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Collecting%20and%20recording%20data%20using%20tables
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Collecting%20and%20recording%20data%20using%20tables

## Revision links
- Sparx topic code: **U120** (paste into Sparx search)
