...
type: skill
id: sparx-u976
title: Using the correct order of operations
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
prereqs:
  - maths-subsection-number-the-order-of-operations-grade-4-6
---
...
- **Can I define it?** Write a one-sentence definition of *Using the correct order of operations* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20the%20correct%20order%20of%20operations
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20the%20correct%20order%20of%20operations
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20the%20correct%20order%20of%20operations

## Revision links
- Sparx topic code: **U976** (paste into Sparx search)
