...
levelId: grade-4-6
prereqs:
  - maths-subsection-geometry-nets-plans-and-elevations-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Plans and elevations**.
...
- **Can I define it?** Write a one-sentence definition of *Plans and elevations* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Plans%20and%20elevations
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Plans%20and%20elevations
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Plans%20and%20elevations

## Revision links
- Sparx topic code: **U743** (paste into Sparx search)
