...
- Write down the given information and what you are asked to find for **Using set notation**.
...
- **Can I define it?** Write a one-sentence definition of *Using set notation* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20set%20notation
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20set%20notation
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20set%20notation

## Revision links
- Sparx topic code: **U296** (paste into Sparx search)
