...
type: skill
id: sparx-u613
title: Using algebraic notation
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
prereqs:
  - maths-subsection-algebra-algebraic-notation-grade-4-6
---

**Strand:** Algebra
**Substrand:** Algebraic notation
**Sparx code:** `U613`
**Sparx levels:** 1, 2, 3, 4, 5

## Key steps (method)

- Write down the given information and what you are asked to find for **Using algebraic notation**.
...
- **Can I define it?** Write a one-sentence definition of *Using algebraic notation* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20algebraic%20notation
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20algebraic%20notation
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20algebraic%20notation

## Revision links
- Sparx topic code: **U613** (paste into Sparx search)
