...
type: skill
id: sparx-u807
title: Proving the circle theorems
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Proving the circle theorems**.
...
- **Can I define it?** Write a one-sentence definition of *Proving the circle theorems* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Proving%20the%20circle%20theorems
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Proving%20the%20circle%20theorems
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Proving%20the%20circle%20theorems

## Revision links
- Sparx topic code: **U807** (paste into Sparx search)
