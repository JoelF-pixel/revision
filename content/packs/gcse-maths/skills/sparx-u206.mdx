...
type: skill
id: sparx-u206
title: Position-to-term rules for quadratic sequences
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Position-to-term rules for quadratic sequences**.
...
- **Can I define it?** Write a one-sentence definition of *Position-to-term rules for quadratic sequences* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Position-to-term%20rules%20for%20quadratic%20sequences
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Position-to-term%20rules%20for%20quadratic%20sequences
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Position-to-term%20rules%20for%20quadratic%20sequences

## Revision links
- Sparx topic code: **U206** (paste into Sparx search)
