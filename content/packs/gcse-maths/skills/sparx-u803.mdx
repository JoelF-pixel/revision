...
type: skill
id: sparx-u803
title: Using probability phrases
...
- Write down the given information and what you are asked to find for **Using probability phrases**.
...
- **Can I define it?** Write a one-sentence definition of *Using probability phrases* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20probability%20phrases
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20probability%20phrases
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20probability%20phrases

## Revision links
- Sparx topic code: **U803** (paste into Sparx search)
