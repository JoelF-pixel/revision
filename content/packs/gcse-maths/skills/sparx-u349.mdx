...
type: skill
id: sparx-u349
title: Finding percentages of amounts with a calculator
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding percentages of amounts with a calculator* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20percentages%20of%20amounts%20with%20a%20calculator
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20percentages%20of%20amounts%20with%20a%20calculator
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20percentages%20of%20amounts%20with%20a%20calculator

## Revision links
- Sparx topic code: **U349** (paste into Sparx search)
