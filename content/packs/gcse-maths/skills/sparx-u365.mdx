...
type: skill
id: sparx-u365
title: Factorising into one bracket
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Factorising into one bracket* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Factorising%20into%20one%20bracket
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Factorising%20into%20one%20bracket
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Factorising%20into%20one%20bracket

## Revision links
- Sparx topic code: **U365** (paste into Sparx search)
