...
type: skill
id: sparx-u541
title: Using Pythagoras' theorem in 3D
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Using Pythagoras' theorem in 3D* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20Pythagoras%27%20theorem%20in%203D
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20Pythagoras%27%20theorem%20in%203D
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20Pythagoras%27%20theorem%20in%203D

## Revision links
- Sparx topic code: **U541** (paste into Sparx search)
