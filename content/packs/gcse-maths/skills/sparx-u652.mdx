...
type: skill
id: sparx-u652
title: Plotting linear real-life graphs
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Plotting linear real-life graphs**.
...
- **Can I define it?** Write a one-sentence definition of *Plotting linear real-life graphs* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Plotting%20linear%20real-life%20graphs
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Plotting%20linear%20real-life%20graphs
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Plotting%20linear%20real-life%20graphs

## Revision links
- Sparx topic code: **U652** (paste into Sparx search)
