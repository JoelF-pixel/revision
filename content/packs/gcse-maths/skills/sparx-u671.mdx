...
type: skill
id: sparx-u671
title: Percentage change with a calculator
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Percentage change with a calculator* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Percentage%20change%20with%20a%20calculator
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Percentage%20change%20with%20a%20calculator
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Percentage%20change%20with%20a%20calculator

## Revision links
- Sparx topic code: **U671** (paste into Sparx search)
