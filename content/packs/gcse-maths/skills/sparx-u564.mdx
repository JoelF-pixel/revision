...
type: skill
id: sparx-u564
title: Multiplying column vectors by a scalar
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Multiplying column vectors by a scalar**.
...
- **Can I define it?** Write a one-sentence definition of *Multiplying column vectors by a scalar* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Multiplying%20column%20vectors%20by%20a%20scalar
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Multiplying%20column%20vectors%20by%20a%20scalar
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Multiplying%20column%20vectors%20by%20a%20scalar

## Revision links
- Sparx topic code: **U564** (paste into Sparx search)
