...
type: skill
id: sparx-u989
title: Plotting graphs of quadratic functions
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Plotting graphs of quadratic functions**.
...
- **Can I define it?** Write a one-sentence definition of *Plotting graphs of quadratic functions* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Plotting%20graphs%20of%20quadratic%20functions
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Plotting%20graphs%20of%20quadratic%20functions
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Plotting%20graphs%20of%20quadratic%20functions

## Revision links
- Sparx topic code: **U989** (paste into Sparx search)
