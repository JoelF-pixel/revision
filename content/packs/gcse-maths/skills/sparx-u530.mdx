...
type: skill
id: sparx-u530
title: Substituting into position-to-term rules
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Substituting into position-to-term rules**.
...
- **Can I define it?** Write a one-sentence definition of *Substituting into position-to-term rules* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Substituting%20into%20position-to-term%20rules
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Substituting%20into%20position-to-term%20rules
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Substituting%20into%20position-to-term%20rules

## Revision links
- Sparx topic code: **U530** (paste into Sparx search)
