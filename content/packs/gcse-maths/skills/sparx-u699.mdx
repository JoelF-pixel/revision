...
type: skill
id: sparx-u699
title: Conditional probabilities from Venn diagrams
...
- Write down the given information and what you are asked to find for **Conditional probabilities from Venn diagrams**.
...
- **Can I define it?** Write a one-sentence definition of *Conditional probabilities from Venn diagrams* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Conditional%20probabilities%20from%20Venn%20diagrams
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Conditional%20probabilities%20from%20Venn%20diagrams
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Conditional%20probabilities%20from%20Venn%20diagrams

## Revision links
- Sparx topic code: **U699** (paste into Sparx search)
