...
type: skill
id: sparx-u681
title: Interpreting quadratic real-life graphs
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Interpreting quadratic real-life graphs**.
...
- **Can I define it?** Write a one-sentence definition of *Interpreting quadratic real-life graphs* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Interpreting%20quadratic%20real-life%20graphs
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Interpreting%20quadratic%20real-life%20graphs
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Interpreting%20quadratic%20real-life%20graphs

## Revision links
- Sparx topic code: **U681** (paste into Sparx search)
