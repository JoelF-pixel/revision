...
type: skill
id: sparx-u660
title: Identifying parallel vectors
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Identifying parallel vectors**.
...
- **Can I define it?** Write a one-sentence definition of *Identifying parallel vectors* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Identifying%20parallel%20vectors
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Identifying%20parallel%20vectors
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Identifying%20parallel%20vectors

## Revision links
- Sparx topic code: **U660** (paste into Sparx search)
