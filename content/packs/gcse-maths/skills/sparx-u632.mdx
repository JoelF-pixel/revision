...
type: skill
id: sparx-u632
title: Understanding column vectors
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Understanding column vectors**.
...
- **Can I define it?** Write a one-sentence definition of *Understanding column vectors* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Understanding%20column%20vectors
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Understanding%20column%20vectors
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Understanding%20column%20vectors

## Revision links
- Sparx topic code: **U632** (paste into Sparx search)
