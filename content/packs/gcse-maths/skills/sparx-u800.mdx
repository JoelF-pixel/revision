...
type: skill
id: sparx-u800
title: Estimating gradients of non-linear graphs using tangents
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Estimating gradients of non-linear graphs using tangents* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Estimating%20gradients%20of%20non-linear%20graphs%20using%20tangents
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Estimating%20gradients%20of%20non-linear%20graphs%20using%20tangents
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Estimating%20gradients%20of%20non-linear%20graphs%20using%20tangents

## Revision links
- Sparx topic code: **U800** (paste into Sparx search)
