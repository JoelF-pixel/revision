...
type: skill
id: sparx-u662
title: Simplifying expressions using index laws
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Simplifying expressions using index laws* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Simplifying%20expressions%20using%20index%20laws
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Simplifying%20expressions%20using%20index%20laws
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Simplifying%20expressions%20using%20index%20laws

## Revision links
- Sparx topic code: **U662** (paste into Sparx search)
