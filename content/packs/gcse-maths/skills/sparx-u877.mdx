...
type: skill
id: sparx-u877
title: Finding averages from grouped data
quadrant: Statistics
ring: Grade 4–6
...
- Write down the given information and what you are asked to find for **Finding averages from grouped data**.
...
- **Can I define it?** Write a one-sentence definition of *Finding averages from grouped data* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20averages%20from%20grouped%20data
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20averages%20from%20grouped%20data
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20averages%20from%20grouped%20data

## Revision links
- Sparx topic code: **U877** (paste into Sparx search)
