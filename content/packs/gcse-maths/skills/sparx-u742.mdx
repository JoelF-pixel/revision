...
type: skill
id: sparx-u742
title: Adding and subtracting with negative numbers
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Adding and subtracting with negative numbers**.
...
- **Can I define it?** Write a one-sentence definition of *Adding and subtracting with negative numbers* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Adding%20and%20subtracting%20with%20negative%20numbers
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Adding%20and%20subtracting%20with%20negative%20numbers
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Adding%20and%20subtracting%20with%20negative%20numbers

## Revision links
- Sparx topic code: **U742** (paste into Sparx search)
