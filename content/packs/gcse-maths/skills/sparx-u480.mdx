...
- Write down the given information and what you are asked to find for **Rounding integers**.
...
- **Can I define it?** Write a one-sentence definition of *Rounding integers* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Rounding%20integers
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Rounding%20integers
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Rounding%20integers

## Revision links
- Sparx topic code: **U480** (paste into Sparx search)
