...
type: skill
id: sparx-u278
title: Finding the percentage an amount has been changed by
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding the percentage an amount has been changed by* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20the%20percentage%20an%20amount%20has%20been%20changed%20by
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20the%20percentage%20an%20amount%20has%20been%20changed%20by
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20the%20percentage%20an%20amount%20has%20been%20changed%20by

## Revision links
- Sparx topic code: **U278** (paste into Sparx search)
