...
type: skill
id: sparx-u235
title: Index rules with positive indices
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Index rules with positive indices* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Index%20rules%20with%20positive%20indices
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Index%20rules%20with%20positive%20indices
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Index%20rules%20with%20positive%20indices

## Revision links
- Sparx topic code: **U235** (paste into Sparx search)
