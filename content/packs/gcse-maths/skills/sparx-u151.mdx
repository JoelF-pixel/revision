...
- Write down the given information and what you are asked to find for **Calculating with speed**.
...
- **Can I define it?** Write a one-sentence definition of *Calculating with speed* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Calculating%20with%20speed
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Calculating%20with%20speed
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Calculating%20with%20speed

## Revision links
- Sparx topic code: **U151** (paste into Sparx search)
