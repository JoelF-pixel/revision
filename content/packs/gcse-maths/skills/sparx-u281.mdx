...
type: skill
id: sparx-u281
title: Rationalising denominators containing two terms
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Rationalising denominators containing two terms* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Rationalising%20denominators%20containing%20two%20terms
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Rationalising%20denominators%20containing%20two%20terms
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Rationalising%20denominators%20containing%20two%20terms

## Revision links
- Sparx topic code: **U281** (paste into Sparx search)
