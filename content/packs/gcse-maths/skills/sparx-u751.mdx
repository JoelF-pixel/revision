...
type: skill
id: sparx-u751
title: Finding the lowest common multiple (LCM)
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Finding the lowest common multiple (LCM)**.
...
- **Can I define it?** Write a one-sentence definition of *Finding the lowest common multiple (LCM)* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20the%20lowest%20common%20multiple%20%28LCM%29
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20the%20lowest%20common%20multiple%20%28LCM%29
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20the%20lowest%20common%20multiple%20%28LCM%29

## Revision links
- Sparx topic code: **U751** (paste into Sparx search)
