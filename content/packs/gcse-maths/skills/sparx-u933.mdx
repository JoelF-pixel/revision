...
- Write down the given information and what you are asked to find for **Calculating midpoints**.
...
- **Can I define it?** Write a one-sentence definition of *Calculating midpoints* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Calculating%20midpoints
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Calculating%20midpoints
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Calculating%20midpoints

## Revision links
- Sparx topic code: **U933** (paste into Sparx search)
