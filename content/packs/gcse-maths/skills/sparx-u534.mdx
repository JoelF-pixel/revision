...
type: skill
id: sparx-u534
title: Using standard form with negative indices
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Using standard form with negative indices* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20standard%20form%20with%20negative%20indices
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20standard%20form%20with%20negative%20indices
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20standard%20form%20with%20negative%20indices

## Revision links
- Sparx topic code: **U534** (paste into Sparx search)
