...
- Write down the given information and what you are asked to find for **Finding error intervals**.
...
- **Can I define it?** Write a one-sentence definition of *Finding error intervals* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20error%20intervals
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20error%20intervals
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20error%20intervals

## Revision links
- Sparx topic code: **U657** (paste into Sparx search)
