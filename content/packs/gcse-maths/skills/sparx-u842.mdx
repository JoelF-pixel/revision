...
type: skill
id: sparx-u842
title: "Mixed problems: Calculating density and pressure"
quadrant: Ratio, Proportion and Rates of Change
ring: Grade 4–6
categoryId: ratio-proportion-and-rates-of-change
levelId: grade-4-6
prereqs:
  - maths-subsection-ratio-proportion-and-rates-of-change-compound-measures-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Mixed problems: Calculating density and pressure**.
...
- **Can I define it?** Write a one-sentence definition of *Mixed problems: Calculating density and pressure* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Mixed%20problems%3A%20Calculating%20density%20and%20pressure
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Mixed%20problems%3A%20Calculating%20density%20and%20pressure
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Mixed%20problems%3A%20Calculating%20density%20and%20pressure

## Revision links
- Sparx topic code: **U842** (paste into Sparx search)
