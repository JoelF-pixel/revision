...
- Write down the given information and what you are asked to find for **Using number lines**.
...
- **Can I define it?** Write a one-sentence definition of *Using number lines* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20number%20lines
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20number%20lines
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20number%20lines

## Revision links
- Sparx topic code: **U922** (paste into Sparx search)
