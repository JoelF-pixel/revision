...
- Write down the given information and what you are asked to find for **Understanding similarity**.
...
- **Can I define it?** Write a one-sentence definition of *Understanding similarity* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Understanding%20similarity
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Understanding%20similarity
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Understanding%20similarity

## Revision links
- Sparx topic code: **U551** (paste into Sparx search)
