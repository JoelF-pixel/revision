...
type: skill
id: sparx-u580
title: Calculating experimental probabilities
quadrant: Probability
ring: Grade 4–6
categoryId: probability
levelId: grade-4-6
prereqs:
  - maths-subsection-probability-experimental-probability-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Calculating experimental probabilities**.
...
- **Can I define it?** Write a one-sentence definition of *Calculating experimental probabilities* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Calculating%20experimental%20probabilities
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Calculating%20experimental%20probabilities
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Calculating%20experimental%20probabilities

## Revision links
- Sparx topic code: **U580** (paste into Sparx search)
