...
type: skill
id: sparx-u448
title: Finding composite functions
quadrant: Algebra
ring: Grade 7–9
categoryId: algebra
levelId: grade-7-9
...
- Write down the given information and what you are asked to find for **Finding composite functions**.
...
- **Can I define it?** Write a one-sentence definition of *Finding composite functions* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20composite%20functions
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20composite%20functions
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20composite%20functions

## Revision links
- Sparx topic code: **U448** (paste into Sparx search)
