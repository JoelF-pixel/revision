...
type: skill
id: sparx-u902
title: Reading, converting and calculating with time
quadrant: Ratio, Proportion and Rates of Change
ring: Grade 4–6
categoryId: ratio-proportion-and-rates-of-change
levelId: grade-4-6
prereqs:
  - maths-subsection-ratio-proportion-and-rates-of-change-time-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Reading, converting and calculating with time**.
...
- **Can I define it?** Write a one-sentence definition of *Reading, converting and calculating with time* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Reading%2C%20converting%20and%20calculating%20with%20time
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Reading%2C%20converting%20and%20calculating%20with%20time
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Reading%2C%20converting%20and%20calculating%20with%20time

## Revision links
- Sparx topic code: **U902** (paste into Sparx search)
