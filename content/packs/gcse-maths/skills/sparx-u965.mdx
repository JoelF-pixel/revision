...
type: skill
id: sparx-u965
title: Rounding decimals using significant figures
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Rounding decimals using significant figures**.
...
- **Can I define it?** Write a one-sentence definition of *Rounding decimals using significant figures* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Rounding%20decimals%20using%20significant%20figures
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Rounding%20decimals%20using%20significant%20figures
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Rounding%20decimals%20using%20significant%20figures

## Revision links
- Sparx topic code: **U965** (paste into Sparx search)
