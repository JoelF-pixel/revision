...
type: skill
id: sparx-u558
title: Tree diagrams for independent events
...
- If the events are **independent**, keep the same probabilities on later stages (they don’t change).
...
- **Can I define it?** Write a one-sentence definition of *Tree diagrams for independent events* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Tree%20diagrams%20for%20independent%20events
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Tree%20diagrams%20for%20independent%20events
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Tree%20diagrams%20for%20independent%20events

## Revision links
- Sparx topic code: **U558** (paste into Sparx search)
