...
- Write down the given information and what you are asked to find for **Symmetry**.
...
- **Can I define it?** Write a one-sentence definition of *Symmetry* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Symmetry
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Symmetry
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Symmetry

## Revision links
- Sparx topic code: **U849** (paste into Sparx search)
