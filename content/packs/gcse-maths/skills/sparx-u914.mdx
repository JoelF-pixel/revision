...
- Write down the given information and what you are asked to find for **Interpreting distance-time graphs**.
...
- **Can I define it?** Write a one-sentence definition of *Interpreting distance-time graphs* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Interpreting%20distance-time%20graphs
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Interpreting%20distance-time%20graphs
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Interpreting%20distance-time%20graphs

## Revision links
- Sparx topic code: **U914** (paste into Sparx search)
