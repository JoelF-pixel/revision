...
type: skill
id: sparx-u735
title: Multiplying and dividing with place value
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Multiplying and dividing with place value**.
...
- **Can I define it?** Write a one-sentence definition of *Multiplying and dividing with place value* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Multiplying%20and%20dividing%20with%20place%20value
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Multiplying%20and%20dividing%20with%20place%20value
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Multiplying%20and%20dividing%20with%20place%20value

## Revision links
- Sparx topic code: **U735** (paste into Sparx search)
