...
type: skill
id: sparx-u870
title: Solving equations with the unknown on both sides
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Solving equations with the unknown on both sides* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Solving%20equations%20with%20the%20unknown%20on%20both%20sides
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Solving%20equations%20with%20the%20unknown%20on%20both%20sides
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Solving%20equations%20with%20the%20unknown%20on%20both%20sides

## Revision links
- Sparx topic code: **U870** (paste into Sparx search)
