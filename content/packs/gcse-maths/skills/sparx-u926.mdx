...
levelId: grade-4-6
prereqs:
  - maths-subsection-number-number-skills-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Using a calculator**.
...
- **Can I define it?** Write a one-sentence definition of *Using a calculator* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20a%20calculator
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20a%20calculator
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20a%20calculator

## Revision links
- Sparx topic code: **U926** (paste into Sparx search)
