...
type: skill
id: sparx-u166
title: Expected results from repeated experiments
...
- Write down the given information and what you are asked to find for **Expected results from repeated experiments**.
...
- **Can I define it?** Write a one-sentence definition of *Expected results from repeated experiments* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Expected%20results%20from%20repeated%20experiments
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Expected%20results%20from%20repeated%20experiments
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Expected%20results%20from%20repeated%20experiments

## Revision links
- Sparx topic code: **U166** (paste into Sparx search)
