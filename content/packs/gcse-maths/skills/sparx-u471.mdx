...
type: skill
id: sparx-u471
title: Geometric proofs with angle facts
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Geometric proofs with angle facts* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Geometric%20proofs%C2%A0with%C2%A0angle%20facts
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Geometric%20proofs%C2%A0with%C2%A0angle%20facts
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Geometric%20proofs%C2%A0with%C2%A0angle%20facts

## Revision links
- Sparx topic code: **U471** (paste into Sparx search)
