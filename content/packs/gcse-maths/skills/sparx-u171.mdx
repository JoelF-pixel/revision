...
type: skill
id: sparx-u171
title: Using recurrence relations
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Using recurrence relations**.
...
- **Can I define it?** Write a one-sentence definition of *Using recurrence relations* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20recurrence%20relations
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20recurrence%20relations
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20recurrence%20relations

## Revision links
- Sparx topic code: **U171** (paste into Sparx search)
