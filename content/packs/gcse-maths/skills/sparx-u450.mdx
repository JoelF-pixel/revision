...
type: skill
id: sparx-u450
title: Using trigonometric graphs
quadrant: Geometry
ring: Grade 7–9
categoryId: geometry
levelId: grade-7-9
...
- **Can I define it?** Write a one-sentence definition of *Using trigonometric graphs* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20trigonometric%20graphs
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20trigonometric%20graphs
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20trigonometric%20graphs

## Revision links
- Sparx topic code: **U450** (paste into Sparx search)
