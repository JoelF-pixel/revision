...
type: skill
id: sparx-u127
title: Using a written method to multiply integers
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Using a written method to multiply integers**.
...
- **Can I define it?** Write a one-sentence definition of *Using a written method to multiply integers* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20a%20written%20method%20to%20multiply%20integers
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20a%20written%20method%20to%20multiply%20integers
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20a%20written%20method%20to%20multiply%20integers

## Revision links
- Sparx topic code: **U127** (paste into Sparx search)
