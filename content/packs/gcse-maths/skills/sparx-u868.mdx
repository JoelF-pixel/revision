...
type: skill
id: sparx-u868
title: Using a written method to divide with decimals
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Using a written method to divide with decimals**.
...
- **Can I define it?** Write a one-sentence definition of *Using a written method to divide with decimals* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Using%20a%20written%20method%20to%20divide%20with%20decimals
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Using%20a%20written%20method%20to%20divide%20with%20decimals
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Using%20a%20written%20method%20to%20divide%20with%20decimals

## Revision links
- Sparx topic code: **U868** (paste into Sparx search)
