...
type: skill
id: sparx-u854
title: Finding averages from diagrams
quadrant: Statistics
ring: Grade 4–6
...
- Write down the given information and what you are asked to find for **Finding averages from diagrams**.
...
- **Can I define it?** Write a one-sentence definition of *Finding averages from diagrams* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20averages%20from%20diagrams
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20averages%20from%20diagrams
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20averages%20from%20diagrams

## Revision links
- Sparx topic code: **U854** (paste into Sparx search)
