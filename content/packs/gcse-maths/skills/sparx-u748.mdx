...
type: skill
id: sparx-u748
title: Venn diagrams with set notation
...
- Write down the given information and what you are asked to find for **Venn diagrams with set notation**.
...
- **Can I define it?** Write a one-sentence definition of *Venn diagrams with set notation* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Venn%20diagrams%20with%20set%20notation
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Venn%20diagrams%20with%20set%20notation
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Venn%20diagrams%20with%20set%20notation

## Revision links
- Sparx topic code: **U748** (paste into Sparx search)
