...
type: skill
id: sparx-u211
title: Finding factors and using divisibility tests
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding factors and using divisibility tests* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20factors%20and%20using%20divisibility%20tests
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20factors%20and%20using%20divisibility%20tests
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20factors%20and%20using%20divisibility%20tests

## Revision links
- Sparx topic code: **U211** (paste into Sparx search)
