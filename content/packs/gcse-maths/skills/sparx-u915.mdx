...
type: skill
id: sparx-u915
title: Finding the volume of cylinders
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding the volume of cylinders* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20the%20volume%20of%20cylinders
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20the%20volume%20of%20cylinders
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20the%20volume%20of%20cylinders

## Revision links
- Sparx topic code: **U915** (paste into Sparx search)
