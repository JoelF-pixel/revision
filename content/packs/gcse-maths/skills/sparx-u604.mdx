...
type: skill
id: sparx-u604
title: Finding the circumference of circles
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding the circumference of circles* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20the%20circumference%20of%20circles
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20the%20circumference%20of%20circles
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20the%20circumference%20of%20circles

## Revision links
- Sparx topic code: **U604** (paste into Sparx search)
