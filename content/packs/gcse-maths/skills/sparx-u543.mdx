...
type: skill
id: sparx-u543
title: Finding the volume of composite shapes
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding the volume of composite shapes* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20the%20volume%20of%20composite%20shapes
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20the%20volume%20of%20composite%20shapes
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20the%20volume%20of%20composite%20shapes

## Revision links
- Sparx topic code: **U543** (paste into Sparx search)
