...
- Write down the given information and what you are asked to find for **Rounding decimals**.
...
- **Can I define it?** Write a one-sentence definition of *Rounding decimals* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Rounding%20decimals
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Rounding%20decimals
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Rounding%20decimals

## Revision links
- Sparx topic code: **U298** (paste into Sparx search)
