...
type: skill
id: sparx-u312
title: Interpreting frequency tables with grouped data
quadrant: Statistics
ring: Grade 4–6
...
- **Can I define it?** Write a one-sentence definition of *Interpreting frequency tables with grouped data* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Interpreting%20frequency%20tables%20with%20grouped%20data
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Interpreting%20frequency%20tables%20with%20grouped%20data
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Interpreting%20frequency%20tables%20with%20grouped%20data

## Revision links
- Sparx topic code: **U312** (paste into Sparx search)
