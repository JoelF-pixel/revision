...
type: skill
id: sparx-u945
title: Finding the area of triangles
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding the area of triangles* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20the%20area%20of%20triangles
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20the%20area%20of%20triangles
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20the%20area%20of%20triangles

## Revision links
- Sparx topic code: **U945** (paste into Sparx search)
