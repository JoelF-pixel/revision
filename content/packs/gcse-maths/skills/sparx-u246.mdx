...
type: skill
id: sparx-u246
title: Conditional probabilities from tables
...
- Write down the given information and what you are asked to find for **Conditional probabilities from tables**.
...
- **Can I define it?** Write a one-sentence definition of *Conditional probabilities from tables* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Conditional%20probabilities%20from%20tables
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Conditional%20probabilities%20from%20tables
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Conditional%20probabilities%20from%20tables

## Revision links
- Sparx topic code: **U246** (paste into Sparx search)
