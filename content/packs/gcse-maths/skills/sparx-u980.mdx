...
type: skill
id: sparx-u980
title: Graphs of cubic functions
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Graphs of cubic functions**.
...
- **Can I define it?** Write a one-sentence definition of *Graphs of cubic functions* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Graphs%20of%20cubic%20functions
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Graphs%20of%20cubic%20functions
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Graphs%20of%20cubic%20functions

## Revision links
- Sparx topic code: **U980** (paste into Sparx search)
