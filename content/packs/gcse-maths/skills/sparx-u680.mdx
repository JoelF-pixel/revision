...
- Write down the given information and what you are asked to find for **Special sequences**.
...
- **Can I define it?** Write a one-sentence definition of *Special sequences* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Special%20sequences
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Special%20sequences
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Special%20sequences

## Revision links
- Sparx topic code: **U680** (paste into Sparx search)
