...
type: skill
id: sparx-u637
title: Substituting into functions
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
prereqs:
  - maths-subsection-algebra-functions-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Substituting into functions**.
...
- **Can I define it?** Write a one-sentence definition of *Substituting into functions* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Substituting%20into%20functions
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Substituting%20into%20functions
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Substituting%20into%20functions

## Revision links
- Sparx topic code: **U637** (paste into Sparx search)
