...
type: skill
id: sparx-u882
title: Estimating areas under non-linear graphs
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Estimating areas under non-linear graphs* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Estimating%20areas%20under%20non-linear%20graphs
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Estimating%20areas%20under%20non-linear%20graphs
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Estimating%20areas%20under%20non-linear%20graphs

## Revision links
- Sparx topic code: **U882** (paste into Sparx search)
