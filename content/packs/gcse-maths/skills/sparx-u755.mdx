...
type: skill
id: sparx-u755
title: Solving equations with one step
quadrant: Algebra
ring: Grade 4–6
categoryId: algebra
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Solving equations with one step* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Solving%20equations%20with%20one%20step
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Solving%20equations%20with%20one%20step
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Solving%20equations%20with%20one%20step

## Revision links
- Sparx topic code: **U755** (paste into Sparx search)
