...
- Write down the given information and what you are asked to find for **Types of data**.
...
- **Can I define it?** Write a one-sentence definition of *Types of data* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Types%20of%20data
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Types%20of%20data
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Types%20of%20data

## Revision links
- Sparx topic code: **U322** (paste into Sparx search)
