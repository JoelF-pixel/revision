...
type: skill
id: sparx-u435
title: Understanding and ordering decimals
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
...
- Write down the given information and what you are asked to find for **Understanding and ordering decimals**.
...
- **Can I define it?** Write a one-sentence definition of *Understanding and ordering decimals* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Understanding%20and%20ordering%20decimals
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Understanding%20and%20ordering%20decimals
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Understanding%20and%20ordering%20decimals

## Revision links
- Sparx topic code: **U435** (paste into Sparx search)
