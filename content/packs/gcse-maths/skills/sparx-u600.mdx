...
type: skill
id: sparx-u600
title: Understanding and ordering integers
quadrant: Number
ring: Grade 4–6
categoryId: number
levelId: grade-4-6
prereqs:
  - maths-subsection-number-place-value-grade-4-6
---
...
- Write down the given information and what you are asked to find for **Understanding and ordering integers**.
...
- **Can I define it?** Write a one-sentence definition of *Understanding and ordering integers* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Understanding%20and%20ordering%20integers
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Understanding%20and%20ordering%20integers
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Understanding%20and%20ordering%20integers

## Revision links
- Sparx topic code: **U600** (paste into Sparx search)
