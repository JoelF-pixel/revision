...
type: skill
id: sparx-u545
title: Finding unknown angles in right-angled triangles
quadrant: Geometry
ring: Grade 4–6
categoryId: geometry
levelId: grade-4-6
...
- **Can I define it?** Write a one-sentence definition of *Finding unknown angles in right-angled triangles* (or the key term in the question).
...
- YouTube (Edexcel GCSE Maths): https://www.youtube.com/results?search_query=edexcel%20gcse%20maths%20Finding%20unknown%20angles%20in%20right-angled%20triangles
- YouTube (Corbettmaths): https://www.youtube.com/results?search_query=corbettmaths%20Finding%20unknown%20angles%20in%20right-angled%20triangles
- YouTube (Maths Genie): https://www.youtube.com/results?search_query=maths%20genie%20Finding%20unknown%20angles%20in%20right-angled%20triangles

## Revision links
- Sparx topic code: **U545** (paste into Sparx search)
