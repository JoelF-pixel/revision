---
type: skill
id: poetry-lr-when-we-two-parted
title: Love & Relationships — When We Two Parted (Lord Byron)
...
**Anthology:** AQA *Past and Present* (Love & Relationships), poem starts p.6.
...
- Full-text search (poem + poet): https://www.google.com/search?q=When+We+Two+Parted+Lord+Byron+full+poem
- Poetry Foundation search: https://www.poetryfoundation.org/search?query=When+We+Two+Parted
...
- YouTube search (Mr Bruff): https://www.youtube.com/results?search_query=when+we+two+parted+mr+bruff
- YouTube search (Stacey Reay): https://www.youtube.com/results?search_query=when+we+two+parted+stacey+reay
...
- Poem-specific analysis search (When We Two Parted): https://www.google.com/search?q=When+We+Two+Parted+Lord+Byron+analysis
- Full-text source search (When We Two Parted): https://www.google.com/search?q=When+We+Two+Parted+Lord+Byron+poem+text
...
- **Neutral Tones** — breakdown of love through bleak imagery and emotional detachment.
- **Winter Swans** — relationship strain and partial reconciliation through natural imagery/structural shift.
