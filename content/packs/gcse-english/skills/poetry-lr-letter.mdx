...
type: skill
id: poetry-lr-letter
title: Love & Relationships — Letters from Yorkshire (Maura Dooley)
...
- Full-text search (poem + poet): https://www.google.com/search?q=Letters+from+Yorkshire+Maura+Dooley+full+poem
- Poetry Foundation search: https://www.poetryfoundation.org/search?query=Letters+from+Yorkshire
...
- Poem-specific analysis search (Letters from Yorkshire): https://www.google.com/search?q=Letters+from+Yorkshire+Maura+Dooley+analysis
- Full-text source search (Letters from Yorkshire): https://www.google.com/search?q=Letters+from+Yorkshire+Maura+Dooley+poem+text
...
- **Mother, any distance** — distance/intimacy negotiated through communication and attachment.
- **Walking Away** — separation and emotional control, with different voices and purposes.
