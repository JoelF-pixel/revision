...
- Full-text search (poem + poet): https://www.google.com/search?q=Follower+Seamus+Heaney+full+poem
- Poetry Foundation search: https://www.poetryfoundation.org/search?query=Follower
...
- Poem-specific analysis search (Follower): https://www.google.com/search?q=Follower+Seamus+Heaney+analysis
- Full-text source search (Follower): https://www.google.com/search?q=Follower+Seamus+Heaney+poem+text
...
- **Climbing My Grandfather** — admiration of an older male figure through extended metaphor and perspective.
- **Before You Were Mine** — memory reshaping family relationships and identity.
