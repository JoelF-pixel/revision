...
- Full-text search (poem + poet): https://www.google.com/search?q=Winter+Swans+Owen+Sheers+full+poem
- Poetry Foundation search: https://www.poetryfoundation.org/search?query=Winter+Swans
...
- Poem-specific analysis search (Winter Swans): https://www.google.com/search?q=Winter+Swans+Owen+Sheers+analysis
- Full-text source search (Winter Swans): https://www.google.com/search?q=Winter+Swans+Owen+Sheers+poem+text
...
- **Neutral Tones** — relationship tension in natural imagery, but different endings/outcomes.
- **Sonnet 29** — intimacy and connection, contrasted with Winter Swans’ fragility and repair.
